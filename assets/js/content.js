...
const reviews =`
<div class="h-fit grid grid-cols-2">
                  <div class="p-4 m-1 items-center justify-center border border-1 rounded-md bg-opacity-50 ">
                    <div class="sm:w-8/12 pl-0 p-5">
                      <div class="space-y-2">
                        <div class="space-y-4">
                          <h4 class="text-md font-semibold text-cyan-900 text-justify">
                            <a href="#">Nice house, it was a pleasure to live here during 2 years</a>
                          </h4>
                        </div>
                        <div class="flex items-center space-x-4 justify-between">
                          <div class="flex gap-3 space-y-1">
                            <img  src="https://flowbite.com/docs/images/people/profile-picture-1.jpg"  class="rounded-full h-8 w-8" />
                            <span class="text-sm">Dennis Palma</span>
                          </div>
