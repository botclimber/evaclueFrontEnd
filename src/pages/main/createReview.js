        ...
        <div class="sm:col-span-full">
          ...
          <div class="mt-2">
            <ul class="flex items-center justify-center">
              <li class="">
                <svg xmlns="http://www.w3.org/2000/svg" class="mr-1 h-5 w-5 text-primary dark:text-primary-400"
              ...
              <li>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                  stroke="currentColor" class="mr-1 h-6 w-6 text-primary dark:text-primary-400">
